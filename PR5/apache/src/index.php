...
$ru_lang = ["Название", "Автор", "", "Добавить файл", "Светлая", "Темная", "Русский", "Английский", "Файл", "Загрузить", "Скачать", "Введите свое имя:", "Язык", "Тема", "Хранилище файлов", "Сменить имя автора"];
$en_lang = ["Name", "Author", "", "Add File", "Light", "Dark", "Russian", "English", "File", "Upload", "Download", "Enter your name:", "Language", "Theme", "File storage", "Change author name"];

$dark_theme = ['table-dark', 'gray', 'bg-dark'];
...
$con = new mysqli("my-sql", "user", "password", "appDB");
